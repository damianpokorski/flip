...
- The add-service probe is an unauthenticated server-side fetch — against an auth-gated dashboard it reflects the *login page's* title/headers, not the real app's. Inherent limitation, not a bug.
