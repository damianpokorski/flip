export const DEFAULT_CONFIG_YAML = `# FLIP configuration — services, workspaces, and global settings all live here.
#
# Global settings:
...
#   services  the services in this workspace, in display order — see below
#
# Each workspace's services — one embedded dashboard/service per entry:
